...
def toChangeUnits(value):
    Tochangeunits = value.split(" ")
    print("Tochangeunits:", Tochangeunits)
    if len(Tochangeunits) == 2:
       if Tochangeunits[1] == "minutes":
          values1 = Tochangeunits[0]+"m"
          print("values1:", values1)
       elif Tochangeunits[1] == "seconds":
            values1 = Tochangeunits[0]+"s"
       elif Tochangeunits[1] =="hours":
            values1 = Tochangeunits[0]+"h"
    else:
        values1 = Tochangeunits[0]
        print("values1:", values1)
    return values1
